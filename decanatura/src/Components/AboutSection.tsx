  ...
  return (
    <div className="relative w-full h-[413px] flex items-center" data-node-id="7:635">
      ...
      <div className="flex flex-col gap-[13px] items-start text-white pl-[80px] w-[612px]" data-node-id="7:636" data-name="Text">
        <p className="font-bold leading-[normal] relative shrink-0 text-[42px] w-full" data-node-id="7:638">
          ¿Cuál es tu punto de partida?
        </p>
        <div className="font-normal leading-[0] relative shrink-0 text-[18px] w-full whitespace-pre-wrap" data-node-id="7:639">
