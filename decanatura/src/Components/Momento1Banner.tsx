    ...
    >
      ...
      <div className="relative h-full flex flex-col items-center justify-center px-[242px]">
        <div className="text-center">
          <p style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }} className="font-bold text-[52px] text-white leading-none font-['Plus_Jakarta_Sans']">
            Momento 1
          </p>
          <p  style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }} className="font-bold text-[36px] text-[#e4eb60] leading-none font-['Plus_Jakarta_Sans']">
            Exploración
          </p>
        </div>
      </div>
